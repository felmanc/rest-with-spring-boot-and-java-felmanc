...
public class User implements UserDetails, Serializable {
	...
	// A tabela do meio (user_permission) pode ser mapeada na User ou Permission, por ser simples (só possui os atributos de id para as tabelas User e permission).
	// A tabela  User foi escolhida por ser a tabela mais forte
	// FetchType.EAGER: Carregando os dados de User, carrega as permissões automaticamente.
